...
module.exports = React.createClass({
  ...
  render() {
	...
	<meta name="google-site-verification" content="q55M-8Gr0WdGW26f9npRjbdlVtzrOVAEUJ9Bgq5l9aQ" />
        ...
        <body>
          ...
          <script async src='https://www.googletagmanager.com/gtag/js?id=UA-135940561-1' />
...
function buildGoogleAdSense() {
  ...
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: 'ca-pub-8085265528165268',
