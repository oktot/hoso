...
module.exports = React.createClass({
  ...
  render() {
    ...
    return (
	  ...
	  <meta name="google-site-verification" content="LiJPoJuqf0v0bjoo5NyidT7lTk3Y9CXjQrbDy1uglfk" />
        ...
        <body>
          ...
          <script async src='https://www.googletagmanager.com/gtag/js?id=UA-120277066-1' />
...
function buildGoogleAdSense() {
  ...
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: 'ca-pub-1186176417890304',
